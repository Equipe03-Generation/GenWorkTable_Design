...
function CadastroTurma() {
    ...
    async function findById(id: string) {
        ...
        async function onSubmit(e: ChangeEvent<HTMLFormElement>) {
            e.preventDefault()
            console.log("temas" + JSON.stringify(turmas))
    ...
    return (
        <Grid className='fundotema'>
            ...
            <form onSubmit={onSubmit}  className='formcadastro'>
                ...
                <TextField className='cortemacaixa' value={turmas.isAtivo} onChange={(e: ChangeEvent<HTMLInputElement>) => updatedTurmas(e)} id="isAtivo" label="Ativo ou Desativado" name="isAtivo" margin="normal" fullWidth />
